...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['id'])) {
    ...
    // Përditëso të dhënat e mentorit
...
<head>
    <meta charset="UTF-8">
    <title>Edito Mentorin</title>
</head>

<body>
    <h1>Edito Mentorin</h1>
    <form method="post" action="edit_mentoret.php">
