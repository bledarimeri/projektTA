...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['id'])) {
    ...
    // Merr të dhënat e desiminatorit
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['id'])) {
    ...
    // Përditëso të dhënat e desiminatorit
...
<head>
    <meta charset="UTF-8">
    <title>Edito Desiminatoret</title>
</head>

<body>
    <h1>Edito Desiminatoret</h1>
    <form method="post" action="edit_desiminatoret.php">
