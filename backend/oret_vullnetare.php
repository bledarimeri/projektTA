  ...
  <div class="form-container">
    ...
    <form method="post" action="" class="needs-validation" novalidate>
      ...
      <div class="mb-3">
        ...
        <input type="date" id="data_fillimit" name="data_fillimit" class="form-control" <?php if ($roleId !== 3): ?>
      ...
      <div class="mb-3">
        ...
        <input type="time" id="ora_fillimit" name="ora_fillimit" class="form-control" <?php if ($roleId !== 3): ?>
          readonly value="readonly" <?php endif; ?> required></textarea>
        <?php if ($roleId !== 3): ?>
        <small class="text-danger">Vetëm desiminatorët mund të plotësojnë këtë fushë.</small>
        <?php endif; ?>
      ...
      <div class="mb-3">
        ...
        <input type="time" id="ora_perfundimit" name="ora_perfundimit" class="form-control" <?php if ($roleId !== 3): ?>
          readonly value="readonly" <?php endif; ?> required></textarea>
        <?php if ($roleId !== 3): ?>
        <small class="text-danger">Vetëm desiminatorët mund të plotësojnë këtë fushë.</small>
        <?php endif; ?>
      ...
      <div class="mb-3">
        ...
        <textarea id="pjesemarresit" name="pjesemarresit" class="form-control" <?php if ($roleId !== 3): ?> readonly
