...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO desiminatoret (emri, mbiemri, email, numri_telefonit, qyteti_rajoni, password) VALUES (:emri, :mbiemri, :email, :numri_telefonit, :qyteti_rajoni, :password)";
    ...
    if ($stmt->execute()) {
        echo "Desiminatori u regjistrua me sukses!";
    } else {
        echo "Gabim gjatë regjistrimit të desiminatorit.";
    }
}
?>
...
<head>
    <meta charset="UTF-8">
    <title>Regjistro Desiminator</title>
    <style>
...
<body>
    <h1>Regjistro Desiminator</h1>
    <form method="post" action="regdesiminatoret.php">
