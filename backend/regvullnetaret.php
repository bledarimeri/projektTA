...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO vullnetaret (emri, mbiemri, email, numri_telefonit, qyteti_rajoni, password) VALUES (:emri, :mbiemri, :email, :numri_telefonit, :qyteti_rajoni, :password)";
    ...
    if ($stmt->execute()) {
        echo "Vullnetari u regjistrua me sukses!";
    } else {
        echo "Gabim gjatë regjistrimit të vullnetarit.";
    }
}
?>
...
<head>
    <meta charset="UTF-8">
    <title>Regjistro Vullnetar</title>
    <style>
...
<body>
    <h1>Regjistro Vullnetar</h1>
    <form method="post" action="regvullnetaret.php">
